...
Komponenttestingene er skrevet med Vitest og @testing-library. Alle komponentene testes i forskjellig grad i totalt 46 tester fordelt på 17 filer. Testfilene er lagt i mapper med navn **tests** på samme sted som filene de tester. For å kjøre alle testene brukes kommandoen `npm run test` . Disse testene utgjør en testdekningsgrad på 88.46%. For å sjekke dekningsgraden kan en bruke kommandoen `npm run coverage` . (NB! Begge disse kommandoene må kjøres i "frontend")
